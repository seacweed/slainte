...
최근 BusinessScene 바텐딩 크기, QHD 기준, 도구장 최종 동작, 스트레이너 충돌, 주문표 대사 표시 규칙은 [BusinessScene 바텐딩 크기·메카닉·주문표 변경 설명서](business-bartending-resolution-and-order-ticket-2026-08-21.md)를 기준으로 확인합니다.
